...
public class ItemInit {
	...
	//Material
	public static final ToolMaterial TOOL_WEATHER = EnumHelper.addToolMaterial("tool_weather", 12, 2000, 20F, 26.0F, 46);
	public static final ArmorMaterial ARMOUR_WEATHER = EnumHelper.addArmorMaterial("armour_weather", Reference.MODID + ":weather",  20, new int[]{8, 13, 17, 8}, 15, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.0F);
